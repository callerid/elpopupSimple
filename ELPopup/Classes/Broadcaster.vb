...
Public Class UdpReceiverClass
    ...
    Sub UdpIdleReceive()
        ...
        Catch ex As Exception
            MsgBox("Could not connect to Ethernet Link port. EL Popup will not recieve new call data until it's restarted.")
            Exit Sub
        End Try
        sReceivedMessage = ""
        While Not done
            ...
            If nByteCount > 24 Or bTestMode = True Then
                If bValidMessage Then RaiseEvent DataReceived()
            End If
